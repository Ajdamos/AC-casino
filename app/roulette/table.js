...
export default function Table(){
    ...
    <div className="token-container">
        ...
        <input className={HandleBorder(chosenValue, e => e.target.value) + " inputcustom"} onClick={e =>HandleValueChange(Number(e.target.value))} width="80" heigth="50" placeholder='Custom value'/>
    </div>
